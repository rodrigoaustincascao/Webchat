        ...
        >
          ...
          <div class="w-9/12 flex flex-col justify-between">
            ...
            >
              <form>
                <div
                  class="flex roudend-md overflow-hidden border border-gray-300"
                >
                  <input
                  ...
                  <button
                    type="submit"
                    class="bg-indigo-500 hover:bg-indigo-00 text-white px-4 py-2"
                  >
                    Enviar
                  </button>
                </div>
